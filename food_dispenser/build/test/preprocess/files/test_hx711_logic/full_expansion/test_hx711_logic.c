...
SM_State sm_next_state(SM_State state, SM_Event evt, 
# 23 "src/dispenser_logic.h" 3 4
                                                    _Bool 
# 23 "src/dispenser_logic.h"
                                                         boot_ok, 
# 23 "src/dispenser_logic.h" 3 4
                                                                  _Bool 
# 23 "src/dispenser_logic.h"
...
# 11 "src/hx711_reader.h" 3 4
_Bool 
# 11 "src/hx711_reader.h"
    hx711_reader_ready(uint8_t ch);
# 9 "test/test_hx711_logic.c" 2
# 1 "build/test/mocks/test_hx711_logic/mock_hx711_reader.h" 1
# 11 "build/test/mocks/test_hx711_logic/mock_hx711_reader.h"
...
void hx711_reader_read_CMockIgnoreAndReturn(UNITY_UINT cmock_line, int32_t cmock_to_return);

void hx711_reader_read_CMockStopIgnore(void);


void hx711_reader_read_CMockExpectAndReturn(UNITY_UINT cmock_line, uint8_t ch, int32_t cmock_to_return);


void hx711_reader_ready_CMockIgnoreAndReturn(UNITY_UINT cmock_line, _Bool cmock_to_return);

void hx711_reader_ready_CMockStopIgnore(void);


void hx711_reader_ready_CMockExpectAndReturn(UNITY_UINT cmock_line, uint8_t ch, _Bool cmock_to_return);
...
# 29 "test/test_hx711_logic.c" 3 4
   1
# 29 "test/test_hx711_logic.c"
   );
...
# 34 "test/test_hx711_logic.c" 3 4
   ((void *)0)
# 34 "test/test_hx711_logic.c"
   ), (UNITY_UINT)(34));
}
...
# 40 "test/test_hx711_logic.c" 3 4
   0
# 40 "test/test_hx711_logic.c"
   );

    float g = read_weight_grams(0U, 0, 420.0f);

    UnityAssertFloatsWithin((UNITY_FLOAT)((0.01f)), (UNITY_FLOAT)((-1.0f)), (UNITY_FLOAT)((g)), (
# 44 "test/test_hx711_logic.c" 3 4
   ((void *)0)
# 44 "test/test_hx711_logic.c"
   ), (UNITY_UINT)(44));
}
